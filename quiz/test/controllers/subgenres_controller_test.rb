...
class SubgenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subgenre" do
    assert_difference('Subgenre.count') do
      post subgenres_url, params: { subgenre: { genre_id: @subgenre.genre_id, name: @subgenre.name, no_of_questions: @subgenre.no_of_questions } }
    end
  ...
  test "should update subgenre" do
    patch subgenre_url(@subgenre), params: { subgenre: { genre_id: @subgenre.genre_id, name: @subgenre.name, no_of_questions: @subgenre.no_of_questions } }
