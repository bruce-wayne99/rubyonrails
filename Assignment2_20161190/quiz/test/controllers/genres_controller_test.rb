...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { name: @genre.name, no_of_questions: @genre.no_of_questions } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { name: @genre.name, no_of_questions: @genre.no_of_questions } }
